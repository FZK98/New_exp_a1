...
maxAmp = 4500# np.random.randint(4500,4600)
b = 0.1
radius1 = (-1*(1/b)*np.log((popt[1]+10*popt[2])/maxAmp))**4
...
for i in range(no_objects):
	...
	x_centre=loctemp[0]
	y_centre=loctemp[1]
#	maxAmp = 5000#np.random.randint(5000,6000)
#	b = 0.1
#	radius1 = (-1*(1/b)*np.log((popt[1]+4*popt[2])/maxAmp))**4
	print(radius1)
	radius1 = int(radius1)
...
#			print(k)
			...
			if radius2<=radius1:
				basearray[j,k] = vaucouleurIntensity(maxAmp, radius2, b)
